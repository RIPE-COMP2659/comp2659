...
&emsp; Once Geo has jumped through the static level, and made it to the end of the scrolling platform- you have beaten the level. Time permitting for level development, they will then proceed to the next level. Once the final level is completed, the player will be returned to the main menu.  
...
- Camera movement vertically so that levels can be "infinitely" tall
...
[2] Free_Games, _"Geometry Dash Assets,"_, Websim, Accessed Jan. 23, 2026. Available: [https://websim.com/@Free_Games/geometry-dash-image-viewer](https://websim.com/@Free_Games/geometry-dash-image-viewer)
