...
/* TODO: Implement test_plot_horizontal_line_basic
 * Test basic horizontal line at origin going right
 */
void test_plot_horizontal_line_basic(void) {
    TEST_IGNORE_MESSAGE("Implement horizontal line tests");
}

/* TODO: Implement test_plot_horizontal_line_with_color
 * Test horizontal line with color parameter (black/white)
 */
void test_plot_horizontal_line_with_color(void) {
    TEST_IGNORE_MESSAGE("Implement horizontal line color tests");
}
