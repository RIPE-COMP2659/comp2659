...
opt_48x48:      
        ...
        move.w  side(a6),d7                     ; get side length (number of rows in pixels)
...
unoptimized:    
        ...
        move.w  side(a6),d7                     ; outer loop: rows (in pixels)
        subq.w  #1,d7                           ; adjust for dbra
