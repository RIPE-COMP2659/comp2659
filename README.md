...
this means that you are passing all tests. A red x:

![alt text](assets/image-1.png)

Means that 1 or more tests failed. To see the output of the tests that were run (and where your submission failed), click on the **actions** section,
